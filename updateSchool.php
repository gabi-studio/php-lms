...
<body>
  ...
  <?php 
      ...
      // if the request method is get and the id is set
      // from the homepage, if the user clicks on the update button
      // then we will get the school from the database
      // just passing the id in the url
      ...
      // the user will fill out the form and then pass the information updated there as a post request
      // then we will update the school in the database
      ...
      <div class="row">
        <div class="col-md-6">
          <form action="updateSchool.php" method="POST">
            <!-- you have id here as a hidden field here-->
